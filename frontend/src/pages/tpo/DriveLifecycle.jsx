        ...
        <form onSubmit={onSubmit} className="space-y-5">
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <div>
              ...
              <input required type="text" className="w-full p-3 border rounded-xl bg-black-50 outline-none focus:bg-white focus:ring-2 focus:ring-blue-500 font-medium text-slate-700"
          ...
          <div>
            ...
            <textarea required className="w-full p-3 border rounded-xl bg-slate-50 outline-none focus:bg-white focus:ring-2 h-24 focus:ring-blue-500 resize-none font-medium text-slate-700"
          ...
          <div className="grid grid-cols-3 gap-5">
            <div>
              ...
              <input required type="number" step="0.1" className="w-full p-3 border rounded-xl focus:ring-blue-500 focus:ring-2 font-medium text-slate-700"
            ...
            <div>
              ...
              <select className="w-full p-3 border rounded-xl focus:ring-blue-500 focus:ring-2 font-medium text-slate-700"
            ...
            <div>
              ...
              <input required type="number" step="0.5" className="w-full p-3 border rounded-xl focus:ring-blue-500 focus:ring-2 font-medium text-slate-700"
          ...
          <div>
            ...
            <input required type="date" className="w-full p-3 border rounded-xl focus:ring-blue-500 focus:ring-2 font-medium text-slate-700"
