...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] text-center">
      <h1 className="text-5xl md:text-6xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-[#aa3bff] to-[#6b21a8]">
      ...
      {user ? (
        ...
        <div className="space-x-4">
          <Link to="/register" className="bg-[#aa3bff] hover:bg-[#902bd9] text-white px-8 py-3 rounded-full font-bold text-lg shadow-lg hover:shadow-xl transition-all">
            Get Started
          </Link>
          <Link to="/login" className="bg-white dark:bg-[#1f2028] text-gray-800 dark:text-white px-8 py-3 rounded-full font-bold text-lg shadow-lg hover:shadow-xl border border-gray-200 dark:border-[#2e303a] transition-all">
            Sign In
          </Link>
        </div>
      )}
